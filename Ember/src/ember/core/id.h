...
#ifndef EMBERENGINE_EMBER_SRC_EMBER_CORE_ID_H
#define EMBERENGINE_EMBER_SRC_EMBER_CORE_ID_H
...
constexpr id_type new_generation(const id_type id)
{
    ...
    EASSERT(gen < ((u64) 1 << detail::generation_bits) - 1);
...
#else
    #define E_TYPED_ID(name) using name = id::id_type;
#endif

} // namespace ember::id

#endif //EMBERENGINE_EMBER_SRC_EMBER_CORE_ID_H
